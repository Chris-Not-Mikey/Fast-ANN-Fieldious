...
def test_internal_node_tree_tb():
    ...
    return 1, run_process(['vcs', '-full64', '-sverilog', '-timescale=1ns/1ps', '-debug_access+pp', 'tests/internal_node_tree_tb.v', 'rtl/internal_node.v', 'rtl/internal_node_tree.v'])
...
def test_new_query_buffer_tb():
    ...
    return 1, run_process(['vcs', '-full64', '-sverilog', '-timescale=1ns/1ps', '-debug_access+pp', 'tests/new_query_row_double_buffer_tb.v', 'rtl/query_row_double_buffer.v',  'rtl/aggregator.v', 'rtl/dual_clock_async_fifo_design.v', 'rtl/ram_sync_1r1w.v'])
