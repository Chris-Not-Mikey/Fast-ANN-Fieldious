...
def test_deaggregator_tb():
    ...
    return 1, run_process(['vcs', '-full64', '-sverilog', '-timescale=1ns/1ps', '-debug_access+pp', 'tests/deaggregator_tb.v', 'rtl/deaggregator.v', 'rtl/dual_clock_async_fifo_design.v'])
