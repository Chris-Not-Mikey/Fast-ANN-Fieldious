...
allow_files = ['top.sv', 'ClockMux.v', 'ResetMux.v', 'SyncPulse.v', 'SyncBit.v', 'WishBoneCtrl.sv', 'QueryPatchMem.v',  'aggregator.v', 'sram_1kbyte_1rw1r.v', 'internal_node_2.v', 'internal_node_tree_2.v', 'LeavesMem.sv', 'BitonicSorter.sv', 'kBestArrays.sv', 'L2Kernel.sv', 'MainFSM.sv', 'RunningMin.sv', 'SyncFIFO.v', 'SortedList.sv']
